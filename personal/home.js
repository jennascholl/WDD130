...
function displayRecipe(data) {
  ...
  const html = `<div id="recipe-box">                 
                  <img id="recipe-photo" src="${results.meals[0].strMealThumb}" alt="Image of ${results.meals[0].strMeal}">
                  ...
                  <input type="button" id="favorites-button" class="button" value="Add to Favorites">
                  <input type="button" id="planner-button" class="button" value="Add to Planner">
